...
namespace Arteria_s.DB.Base
{
	public abstract class VSQLContext
	{
		...
		abstract public bool SaveCertificate(uint uAuthorityId, uint uInstance, ref ItemsMentioned m_pItems, ref string m_pCrt, ref string m_pKey, X509Certificate2 m_pCertificate);
